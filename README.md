...
| **Automated suite** | **381 tests** (373 pass on a fresh clone; the other 8 need a live Supabase `DATABASE_URL`); GitHub Actions also runs `pip-audit` and `bandit` |
...
│   └── tests/                381 automated tests (+ manual real-video end-to-end scripts)
